                ...
                <div class="blog-identity">
                    ...
                    <?php if ( $footer_logo = get_field('footer_logo', 'options') ) : ?>
                        <a href="<?php echo home_url(); ?>" class="blog-logo">
                            <img src="<?php echo $footer_logo['sizes']['medium']; ?>" alt="<?php echo bloginfo('name'); ?>">
                        </a>
                    <?php endif; ?>
                    
                    <?php if ( $moto = get_field('footer_moto', 'options') ) : ?>
                        <p class="blog-moto"><?php echo $moto; ?></p>
                    <?php endif; ?>
