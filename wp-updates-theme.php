...
new WPUpdatesThemeUpdater_2249( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_2249') ) {
    class WPUpdatesThemeUpdater_2249 {
